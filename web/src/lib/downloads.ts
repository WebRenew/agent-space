...
const AGENT_SPACE_REPO_PATH = new URL(SITE_REPO_URL).pathname.replace(
  /^\/|\/$/g,
  ""
);
export const AGENT_SPACE_RELEASES_API_URL = `https://api.github.com/repos/${AGENT_SPACE_REPO_PATH}/releases/latest`;
